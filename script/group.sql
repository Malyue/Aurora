...
(
    ...
    `is_overt`     tinyint(4) unsigned NOT NULL DEFAULT '2' COMMENT '是否公开可见[1:否;2:是;]',
    `is_mute`      tinyint(4) unsigned NOT NULL DEFAULT '1' COMMENT '是否全员禁言 [1:否;2:是;]，提示:不包含群主或管理员',
    `is_apply`     tinyint(4) unsigned NOT NULL DEFAULT '2' COMMENT '是否需要审批[1:否;2:是]',
    `is_allow_invite` tinyint(4) unsigned NOT NULL DEFAULT '2' COMMENT '是否允许邀请[1:否;2:是],不包括群主和管理员',
